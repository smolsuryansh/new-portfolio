...
const Projects = ({ targetRef }) => {
    ...
    return (
        ...
        <div id='work' ref={targetRef} className='bg-background pt-[8vw] pb-[12vw]'>
            <div id='workrow' className='flex items-center justify-between text-fontMain px-[13vw] pr-[10vw]'>
                <h1 className='text-[7vw]'>My Proje<span className='font-Beanco-Font text-[10vw] text-fontSpecial'>c</span>ts</h1>
                <div className='pr-[30vw] pt-[3vw]'>
                    (03)
                </div>
                <svg id="o-ui-arrow" width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" className='stroke-fontMain opacity-[0.6] scale-x-[-1]'>
