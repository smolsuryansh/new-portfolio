...
const Contact = () => {
    return (
        <div id='contact' className='bg-contact py-[6vw]'>
            ...
            <div className='flex items-center justify-center pt-[7vw]'>
                <a href='mailto:suryanshdubey2525@gmail.com' target='_blank' className='relative overflow-hidden text-white bg-contact py-[2vw] px-[14vw] border-[0.1vw] border-white rounded-full transition-all ease-out duration-300 group hover:text-black'>
            ...
            <div className='px-[4vw]'>
                <div className='md:flex relative items-center justify-between pt-[7vw] gap-[2vw]'>
                    ...
                    <a href='https://www.linkedin.com/in/suryansh-dubey-271418285/' target='_blank' rel="noopener noreferrer" 
                        ...
                        <span className='absolute inset-0 bg-contactHover scale-y-0 origin-top transition-transform duration-300 ease-out group-hover:scale-y-100'></span>
