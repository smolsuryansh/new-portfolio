    ...
    return (
        <div>
            <div className='bg-[#102127] w-full overflow-hidden px-[5vw] py-[6vw] pt-[18vw] text-white'>
                <svg id='o-ui-arrow' width="64" height="64" viewBox='0 0 64 64' fill='none' xmlns='http://www.w3.org/2000/svg' className='stroke-white opacity-[0.6]'>
                ...
                <h5 className='opacity-[0.6] text-[12px] pl-[8.5vw]'>
